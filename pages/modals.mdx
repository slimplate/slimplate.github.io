...
The ModalNewProject component can be used to display a modal allowing you to select a Github repo. The project can be either private or public.


```js copy filename="jsx" /AdminCollection/
