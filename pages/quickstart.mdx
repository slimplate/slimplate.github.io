...
3. Wrap your application root component with [SlimplateProvider](/provider#slimplateprovider). As well as indicating our `corsProxy`, `backendURL`, and `monoProject`.
```jsx
